...
public class Student {
	...
	public Student(Integer id, String name, String lastname, Gender gender, LocalDate birthdate, double avg,
	...
	public Student(String name, String lastname, Gender gender, LocalDate birthdate, double avg,
			double min_vote, double max_vote) {
		super();
		this.name = name;
		this.lastname = lastname;
